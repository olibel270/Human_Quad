...
import rospy
from pymavlink.dialects.v10 import common as MAV_APM
from mavros.mavlink import convert_to_rosmsg
from mavros_msgs.msg import Mavlink

# Global position of the origin
lat = 45.546541 * 1e7   # Terni
lon = -73.606242  * 1e7   # Terni
alt = 1 * 1e3
...
def set_global_origin(mav, pub):
    ...
    msg = MAV_APM.MAVLink_command_long_message(0,0,48,1,1,0,0,0,0,0,0)
...
def set_home_position(mav, pub):
    ...
    msg = MAV_APM.MAVLink_command_long_message(0,0,179,1,1,0,0,0,0,0,0)
